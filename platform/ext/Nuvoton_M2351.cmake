...
elseif(BUILD_TARGET_CFG)
  ...
  list(APPEND ALL_SRC_C_S "${PLATFORM_DIR}/target/Nuvoton/M2351/services/src/tfm_platform_system.c")
  embedded_include_directories(PATH "${PLATFORM_DIR}/common" ABSOLUTE)
endif()
...
elseif(BUILD_PLAT_TEST)
  list(APPEND ALL_SRC_C "${PLATFORM_DIR}/target/Nuvoton/M2351/plat_test.c")
endif()
